...
RELATE_RELATION_RESULT_KEY = _build_key(RELATE_RELATION, JOBSTEP_RESULT)
RELATE_RESULT_KEY = _build_key(RELATE_RELATION, JOBSTEP_RESULT)
...
EXPORT_TEST_REQUEST_KEY = _build_key(EXPORT, REQUEST)
...
RELATE_RELATION_REQUEST_KEY = _build_key(RELATE_RELATION, REQUEST)
...
RELATE_RELATION_QUEUE = _build_queuename(WORKFLOW_EXCHANGE, RELATE_RELATION)
...
QUEUE_CONFIGURATION = {
    WORKFLOW_EXCHANGE: {
        ...
        RELATE_RELATION_QUEUE: [
            RELATE_RELATION_REQUEST_KEY,
        ],
        RELATE_QUEUE: [
            RELATE_REQUEST_KEY,
        ],
