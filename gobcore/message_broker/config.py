...
RELATE_TABLE_RESULT_KEY = _build_key(RELATE_TABLE, JOBSTEP_RESULT)
...
RELATE_TABLE_REQUEST_KEY = _build_key(RELATE_TABLE, REQUEST)
...
RELATE_TABLE_QUEUE = _build_queuename(WORKFLOW_EXCHANGE, RELATE_TABLE)
