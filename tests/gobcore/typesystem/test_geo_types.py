...
class TestGobGeoTypes(unittest.TestCase):
    ...
    def test_gob_point(self):
        ...
        self.assertEqual('POINT(112 22)', str(GobType.from_values(x=112, y=22)))
        ...
        self.assertEqual('POINT(112 22)', str(GobType.from_value('POINT(112 22)')))
        ...
        mock_db_field.desc = 'POINT(112 22)'

        self.assertEqual('POINT(112 22)', str(GobType.from_value(mock_db_field)))
