...
class TestIssue(TestCase):
    ...
    def _some_issue(self):
        entity = {
            'id': 'any id',
            'attr': 'any attr'
        }
        return Issue('any check', entity, 'id', 'attr')
    ...
    def test_issue(self):
        ...
        issue = Issue('any check', entity, 'id', 'attr')
        self.assertEqual(issue.check, 'any check')
        ...
        issue = Issue('any check', entity, None, 'attr')
        ...
        issue = Issue('any check', entity, None, 'attr', 'other attr')
